<div class="fixed h-full flex bg-white dark:bg-gray-800  dark:border-gray-700 border lg:shadow-sm overflow-hidden inset-0 lg:top-16 lg:inset-x-2 m-auto lg:h-[90%] rounded-lg" >
    ...
    <main class="hidden md:grid w-full border-l dark:border-gray-700 h-full relative overflow-y-auto"  style="contain:content">
        <div class="m-auto text-center justify-center flex gap-3 flex-col   col-span-12">
